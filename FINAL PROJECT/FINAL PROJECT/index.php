				...
				if($level == 'Mahasiswa'){
			    	...
			    	if($status == 'Aktif')
			    	{
						...
						$_SESSION['status'] = "login";
	      				echo'<script language="javascript">alert("Anda berhasil login sebagai Mahasiswa"); document.location="homemhs.php"; </script>';
			    	}
			    	else
			    	{
			    	...
			    	if($status == 'Aktif')
			    	{
				    	$status = $hasil['status'];
		      			...
		      			$_SESSION['email'] = $row['email'];
						$_SESSION['status'] = "login";
		      			echo'<script language="javascript">alert("Anda berhasil login sebagai Dosen"); document.location="homedosen.php"; </script>';
		      		}
		      		else
			    	{
						echo"<script>alert('Status anda saat ini adalah ".$status.", mohon kontak administrator untuk pengaktifan');</script>";	
			    	...
			    	$hasil = mysqli_fetch_array($cek);
	      			...
	      			$_SESSION['email'] = $row['email'];
					$_SESSION['status'] = "login";
	      			echo'<script language="javascript">alert("Anda berhasil login sebagai Admin"); document.location="homeadmin.php"; </script>';
	     		}
			}
			else
			{
